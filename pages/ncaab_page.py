...
sport_wagers_page.render(
    ...
    leaderboard_urls_dict=dict(
        field_goals_attempted="https://www.teamrankings.com/ncaa-basketball/stat/field-goals-attempted-per-game",
        field_goals_made="https://www.teamrankings.com/ncaa-basketball/stat/field-goals-made-per-game",
